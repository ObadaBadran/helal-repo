...
<head>
    <meta charset="UTF-8">
    <title>تذكير بموعد درس خاص قريب / Upcoming Private Lesson Reminder</title>
    <style>
        body {
...
<div class="email-container">
    ...
    <p class="dual-text">
        <span class="ar">هذا تذكير بموعد درس خاص مدفوع قريب:</span>
        <span class="en">This is a reminder for an upcoming paid private lesson:</span>
    </p>

    <div class="consultation-details orange">
        <h3 style="color: #ff9800; margin-top: 0;">تفاصيل الدرس الخاص / Private Lesson Details</h3>
        <p class="dual-text">
            <span class="label">مكان الدرس (place):</span>
            <span
                class="value">{{ $privateLessonInformation->place_ar ?? 'N/A' }} / {{ $privateLessonInformation->place_en ?? 'N/A' }}</span>
        </p>
        <p class="dual-text">
            <span class="label">المبلغ (Amount):</span>
            <span class="value">
                    {{ $privateLessonInformation->price_usd ?? 'N/A' }} USD -
                    {{ $privateLessonInformation->price_aed ?? 'N/A' }} AED
            </span>
        </p>
        <p class="dual-text"><span class="label">المدة (Duration):</span> <span class="value">{{ $privateLessonInformation->duration ?? 'N/A' }} دقائق / minutes</span>
        </p>
    </div>
    ...
    <div class="footer dual-text">
        <span class="ar">يرجى التحضير للدرس الخاص والتأكد من جاهزية جميع المتطلبات.</span>
        <span class="en">Please prepare for the private lesson and ensure all requirements are ready.</span>
    </div>
